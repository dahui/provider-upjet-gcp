...
type AclParameters struct {
	...
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractParamPath("cluster_id",false)
	// +kubebuilder:validation:Optional
	Cluster *string `json:"cluster,omitempty" tf:"cluster,omitempty"`
...
// Acl is the Schema for the Acls API. A Managed Service for Apache Kafka ACL.
