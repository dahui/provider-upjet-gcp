...
func main() {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-gcp-managedkafka",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup_managedkafka(mgr, o), "Cannot setup GCP controllers")
